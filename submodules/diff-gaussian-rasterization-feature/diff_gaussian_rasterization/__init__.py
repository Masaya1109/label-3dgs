...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                ...
                num_rendered, color, label, depth, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        # ctx.save_for_backward(colors_precomp, semantic_feature, means3D, scales, rotations, cov3Ds_precomp, radii, sh, geomBuffer, binningBuffer, imgBuffer)
        ctx.save_for_backward(colors_precomp, label, means3D, scales, rotations, cov3Ds_precomp, radii, sh, geomBuffer, binningBuffer, imgBuffer) ###d
        # return color, feature_map, radii ###
        # return color, featrue_map, radii, depth
        return color, label, radii, depth
    ...
    def backward(ctx, grad_out_color, 
        ...
        # colors_precomp, semantic_feature, means3D, scales, rotations, cov3Ds_precomp, radii, sh, geomBuffer, binningBuffer, imgBuffer = ctx.saved_tensors 
        colors_precomp, labels, means3D, scales, rotations, cov3Ds_precomp, radii, sh, geomBuffer, binningBuffer, imgBuffer = ctx.saved_tensors 
        ...
        if raster_settings.debug:
            ...
            try:
                ...
                grad_means2D, grad_colors_precomp, grad_labels, grad_opacities, grad_means3D, grad_cov3Ds_precomp, grad_sh, grad_scales, grad_rotations = _C.rasterize_gaussians_backward(*args) ###d
            except Exception as ex:
...
class GaussianRasterizer(nn.Module):
    ...
    def forward(self, means3D, means2D, opacities, shs = None,
                ...
                labels = None,
                colors_precomp = None, scales = None, rotations = None, cov3D_precomp = None): ###d
        raster_settings = self.raster_settings
